...
DEBUT
    ...
    ; Code d'Antoine revue et nettoyé
...
init_tempo
    movlw   0xff		    ; initialise les valeurs des compteurs 1 et 2 à 255
    movwf   cpt1
    movwf   cpt2
    movlw   0x6			    ; initialise la valeur du compteur 3 à 6
    movwf   cpt3
    goto    tempo

tempo
    decf    cpt1		    ; décrémente le compteur 1
    movlw   0x00
    cpfseq  cpt1, ACCESS	    ; test si le compteur 1 vaut 0
    goto    tempo		    ; retourne au début de la routine
    
    ; si cpt1 = 0
    decf    cpt2		    ; décrémente le compteur 2
    call    reset1		    ; appel la routine qui reset la valeur du compteur 1
    movlw   0x00
    cpfseq  cpt2, ACCESS	    ; test si le compteur 2 vaut 0
    goto    tempo
